    ...
    <section id>
        ...
        <div className="flex flex-row justify-around items-center flex-wrap my-16 xl:mx-auto max-w-cont">
            ...
            <div className="bg-pe bg-no-repeat bg-center bg-cover m-8 w-56 h-16">
                <a className="h-full block bord focus:border-neutral-900 hover:border-neutral-900" ariaLabel="go to project euler" rel="noopener noreferrer" href="https://projecteuler.net"></a>
            </div>
            <div className="bg-cw lg:bg-cw-lg bg-no-repeat bg-center bg-cover m-8 w-48 h-8 lg:w-cw-lg lg:h-10">
                <a className="h-full block bord focus:border-neutral-900 hover:border-neutral-900" ariaLabel="go to my codewars profile" rel="noopener noreferrer" href="https://www.codewars.com/users/jamessouth"></a>
            </div>
        </div>
    </section>
};