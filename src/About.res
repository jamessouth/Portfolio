...
let make = () => {
  ...
  <section className="flex flex-col" id="about">
    <div className="bg-contain bg-no-repeat bg-top h-80 bg-about" />
    <div className="">
      <h1
        className="mb-10 mw500:mt-5 mw560:mt-10 font-bold font-corm text-center text-4xl md:text-5xl lg:text-6xl">
